package com.zlyandroid.wanandroid.https.download;
    ...
    private Source source(Source source) {
        return new ForwardingSource(source) {
            ...
            public long read(Buffer sink, long byteCount) throws IOException {
                ...
                Log.d("","download progress readBytesCount:" + readBytesCount + "  totalBytesCount:" + totalBytesCount + " callback:" + callback);
                if (callback != null) {
